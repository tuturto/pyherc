...
def init_creatures(context):
    ...
    config.append(CreatureConfiguration(name = 'rat',
                                        ...
                                        hp = 2,
                                        speed = 2,
                                        icons = surface_manager.add_icon('rat', ':mouse.png', 'r'),
                                        attack = 1,
    ...
    config.append(CreatureConfiguration(name = 'fire beetle',
                                        ...
                                        hp = 4,
                                        speed = 3,
                                        icons = surface_manager.add_icon('fire beetle', ':scarab-beetle.png', 'a'),
                                        attack = 2,
                                        ai = FlockingHerbivore))
    ...
    config.append(CreatureConfiguration(name = 'skeleton warrior',
                                        ...
                                        hp = 8,
                                        speed = 4,
                                        icons = surface_manager.add_icon('skeleton warrior', ':blade-bite.png', 'Z'),
                                        attack = 1,
