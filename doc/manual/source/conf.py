...
project = u'Herculeum'
copyright = u'2010-2014, Tuukka Turto'
...
version = PYHERC_VERSION
# The full version, including alpha/beta/rc tags.
release = PYHERC_VERSION
...
latex_documents = [
  ('index', 'pyherc.tex', u'pyherc Documentation',
   u'Tuukka Turto', 'manual'),
]
...
man_pages = [
    ('index', 'pyherc', u'pyherc Documentation',
     [u'Tuukka Turto'], 1)
]
...
texinfo_documents = [
  ('index', 'pyherc', u'pyherc Documentation',
   u'Tuukka Turto', 'pyherc', 'One line description of project.',
   'Miscellaneous'),
]
